...
def main():
    ...
    try:
        from ttl_barcoder.hardware.pigpio import PigpioBarcodeSender, PigpioConnection, send_barcode_sequence
    ...
    print(f"\nHardware Setup:")
    print(f"1. Ensure pigpio daemon is running: sudo systemctl start pigpio")
    print(f"2. Connect TTL output to GPIO pin {gpio_pin}")
    print(f"3. Connect ground reference")
    print(f"4. Verify with oscilloscope or logic analyzer")
    print(f"5. Uncomment transmission code above to execute")
