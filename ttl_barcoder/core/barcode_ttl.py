...
class BarcodeTTL:
    ...
    def get_multiple_sequences(self, count: int = 1, 
                              interval_s: float = 5.0,
                              start_timestamp: Optional[float] = None) -> List[List[Tuple[bool, float]]]:
        """
    ...
    def recover_timestamp(self, barcode_value: int,
